...
Autonomous Gorilla AI – The gorilla walks randomly, approaches trees, and interacts with them in a lifelike manner.

Tree Interaction – Trees can be damaged and destroyed, complete with explosion animations and stumps.
...
├── gorilla_tree_interaction.py  # Interaction animation logic
